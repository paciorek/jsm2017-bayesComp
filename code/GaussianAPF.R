...
## Expected values
pdf(file.path("plots", "Gaussian_means_APF.pdf"))
plot(theta.t, type="n", xlab="t",
...
legend(115,4,c("Exact","SIR","APF"), col=c("red","blue","green"),
...
plot(theta.t, type="n", xlab="t", ylab=
    expression(paste("95% credible interval for ",theta[t])), lwd=2)
...
pdf(file.path("plots", "Gaussian_ESSintime_APF.pdf"))
plot(ESS.SIR[-1], type="l", ylab="ESS", xlab="t", ylim=c(0,BB), lty=3,
     col="blue")
lines(ESS.APF[-1],lty=4, col="green")
legend(120,9000,c("SIR","APF"), col=c("blue","green"), lty=c(3,4),
       lwd=2, bty="n")
dev.off()
